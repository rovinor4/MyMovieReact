...
function App() {
    ...
    const Tables = () => {
        if (film.length > 0) {
                                ...
                                <tr key={item.id}>
                                    ...
                                    <td>
                                        <div className='d-flex gap-2 justify-content-center'>
                                            <Link to={"/admin/kategori/edit/" + item.id}>
            ...
            return <h3 className='mx-auto text-center mt-4 fw-bold text-primary'>Data Kategory Tidak Di Temukan</h3>;
        }
    }
        ...
        <Bs.Container className="pt-5">
            <div className='shadow-sm border p-4 rounded-4 bg-white'>
                ...
                <div className='d-flex w-100 justify-content-end gap-2'>
                    <Link to={"/admin/kategori/add"}>
                        <Bs.Button >Add Kategori</Bs.Button>
                    </Link>
                </div>
                <Tables />
            </div>
